...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Fake_World_TG")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/trinetra_network")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "https://t.me/trinetra_network")

# 𝐃𝐨 𝐍𝐨𝐭 𝐂𝐡𝐚𝐧𝐠𝐞 𝐓𝐡𝐢𝐬 𝐋𝐢𝐧𝐞𝐬 // 𝐈𝐠𝐧𝐨𝐫𝐞 𝐓𝐡𝐢𝐬 (Brutal Rajput) 
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
PROFILE_CHANNEL = getenv("PROFILE_CHANNEL", "https://t.me/trinetra_network")
